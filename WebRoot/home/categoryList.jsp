  ...
  <body>
    ...
    <script>
        function showProductsAsideCategorys(cid){
            ...
            $("div.eachCategory[cid="+cid+"] a").css({"color":"#FF0036","text-decoration":"none"});
            $("div.productsAsideCategorys[cid="+cid+"]").show();
        }

        function hideProductsAsideCategorys(cid){
            $("div.eachCategory[cid="+cid+"]").css({"background-color":"black","opacity":"0.7"});
    ...
    <div class="categoryWithCarousel">
        <div style="position: relative">
            ...
            <c:forEach items="${cate_list}" var="cate" varStatus="status">
                <div class="eachCategory" cid="${cate.id}">
