            ...
            <div class="productList">
                ...
                <table class="productTable">
                    ...
                    <tbody class="productListTbody">
                        <tr class="orderItemTR">
                            <td class="orderItemFirstTD"colspan="2"><img width="20px" src="${pageContext.request.contextPath}/productSingle_middle/${product.firstProductImage.id}.jpg" class="orderItemImg">
                            <td class="orderItemProductInfo">
                                <a class="orderItemProductLink">${product.name}</a>
                            <div>
                            ...
                            <td>
                            <c:forEach items="${prop_value_list}" var="prop_value" varStatus="status">
                            <c:if test="${status.count<3}">
                                <div class="categoryEachOne">${prop_value.property.name}:${prop_value.value}</div>
                            </c:if>
                            </c:forEach>
                            </td>
                            <td>
                ...
                <div class="orderItemTotalSumDiv">
                    <div class="pull-right">
                        <span>实付款:</span>
                        <span class="orderItemTotalSumSpan">¥<fmt:formatNumber value="${product.promotePrice*buynum}" pattern="#0.00"/></span>
                    </div>
                </div>
